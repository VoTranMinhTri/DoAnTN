        ...
        <div class="page-breadcrumb">
            <div class="row">
                <div class="col-12 d-flex no-block align-items-center">
                    <h4 class="page-title">Thêm phiếu giảm giá</h4>
                </div>
            </div>
        </div>
        <!-- ============================================================== -->
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <hr>
                            <form action="{{ route('phieuGiamGia.store') }}" method="post" accept-charset="utf-8">
                                @csrf
                                <div class="row">
                                    <div class="col-sm-12">
                                        <h4 class="card-title">PHIẾU GIẢM GIÁ MỚI</h4>
                                        <div class="row">
                                            <div class="col-sm-6">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <input class="form-control" name="ngaybatdau" type="date"
                                                            style="height: 40px;"
                                                            placeholder="Ngày bắt đầu" value="" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <input class="form-control" name="ngayhethan" type="date"
                                                            style="height: 40px;"
                                                            placeholder="Ngày kết thúc" value="" required>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
