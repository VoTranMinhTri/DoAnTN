                ...
                <ul id="sidebarnav" class="pt-3">
                    ...
                    <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="#"
                        ...
                        <ul aria-expanded="false" class="collapse  first-level">
                            <li class="sidebar-item"><a href="/product" class="sidebar-link"><i
                                        class="me-2 mdi mdi-record"></i></i><span class="hide-menu">Quản lý
                                        khách hàng
                                    </span></a></li>
                    ...
                    <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="#"
                        ...
                        <ul aria-expanded="false" class="collapse  first-level">
                            ...
                            <li class="sidebar-item"><a href="#" class="sidebar-link"><i
                                        class="me-2 mdi mdi-record"></i></i><span class="hide-menu">Phân bố sản phẩm
                                    </span></a></li>
                        </ul>
                    </li>
                    <div class="title-header">
                        <div class="menu-title">
                            <span style="color:white;">BÁO CÁO - TÙY CHỈNH</span>
                        </div>
                    </div>
                    ...
                    <div class="card card-hover">
                        <a href="/chart">
                            <div class="box bg-success text-center">
                                ...
                                <h6 class="text-white">Biểu đồ</h6>
                            </div>
                        </a>
                    </div>
                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6 mt-3">
                                            <div class="bg-dark p-10 text-white text-center">
                                                ...
                                                <small class="font-light">Những đơn hàng chưa giải quyết</small>
                                            </div>
                                        </div>
                                        <div class="col-6 mt-3">
                                            <div class="bg-dark p-10 text-white text-center">
                                                ...
                                                <small class="font-light">Những đơn hàng online</small>
                                            </div>
                                        </div>
                                    </div>
                                </div>
