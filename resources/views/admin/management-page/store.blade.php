                    ...
                    <div class="card">
                        <div class="card-body">
                            @if (Auth::user()->loai_tai_khoan_id == 1)
                                <a href="{{ route('cuaHang.create') }}"><button type="button"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if (Auth::user()->loai_tai_khoan_id == 1)
                                                        ...
                                                        <a href="{{ route('cuaHang.show', ['cuaHang' => $tp]) }}"><button
                                                                type="button" class="btn btn-outline-info"
                                                                title="Xem chi tiết cửa hàng"><i
                                                                    class="fas fa-info"></i></button></a>
                                                        <button type="button" class="btn btn-outline-danger"
                                                            onclick="confirm('{{ route('cuaHang.destroy', ['cuaHang' => $tp]) }}')"
                        ...
                        <div class="popup">
                            ...
                            <div class="form-popup" style="width: auto">
                                <div class="row-popup">
                                    <h3 style="color:red;text-align: center;">Xóa cửa hàng</h3>
                                </div>
                                <form method="post" action="#" id="formdelete">
                                    @csrf
                                    @method('DELETE')
                                    <h4 style="display:block">Bạn có muốn xóa cửa hàng này không
                                        ?</h4>
