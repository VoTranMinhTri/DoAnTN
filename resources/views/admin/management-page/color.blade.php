        ...
        <div class="page-breadcrumb">
            <div class="row">
                <div class="col-12 d-flex no-block align-items-center">
                    <h4 class="page-title">Quản lý màu</h4>
                </div>
            </div>
        </div>
        <!-- ============================================================== -->
                    ...
                    <div class="card">
                            ...
                            <a href="{{ route('mauSac.create') }}"><button type="button" class="btn btn-outline-primary">
                                    ...
                                    <div class="table-responsive">
                                        <table id="zero_config" class="table table-striped table-bordered">
                                            ...
                                            <tbody>
                                                <?php $i = 0; ?>
                                                @foreach ($danhSachMau as $tp)
                                                    <tr>
                                                        <td><?php echo ++$i; ?></td>
                                                        <td>{{ $tp->ten_mau_sac }}</td>
                                                        <td>
                                                            <a href="{{ route('mauSac.edit', ['mauSac' => $tp]) }}"><button
                                                                    type="button" class="btn btn-outline-secondary"
                                                                    title="Chỉnh sửa thông tin màu"><i
                                                                        class="far fa-edit"></i></button></a>
                                                            <button type="button" class="btn btn-outline-danger"
                                                                onclick="confirm('{{ route('mauSac.destroy', ['mauSac' => $tp]) }}')"
                                                                title="Xóa màu"><i class="fas fa-trash"></i></button>
                                                        </td>
                                                    </tr>
                                                @endforeach
                        ...
                        <div class="popup">
                            ...
                            <div class="form-popup" style="width: auto">
                                <div class="row-popup">
                                    <h3 style="color:red;text-align: center;">Xóa màu</h3>
                                </div>
                                <form method="post" action="#" id="formdelete">
                                    @csrf
                                    @method('DELETE')
                                    <h4 style="display:block">Bạn có muốn xóa màu này không
                                        ?</h4>
