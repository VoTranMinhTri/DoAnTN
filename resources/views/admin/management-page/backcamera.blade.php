        ...
        <div class="page-breadcrumb">
            <div class="row">
                <div class="col-12 d-flex no-block align-items-center">
                    <h4 class="page-title">Quản lý camera sau</h4>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <a href="#"><button type="button" class="btn btn-outline-primary">
                                <i class="fas fa-plus-circle"></i> THÊM CAMERA SAU
                            </button><a>
                                <hr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <button type="button" class="btn btn-outline-secondary"
                                                    title="Chỉnh sửa thông tin camera sau"><i
                                                        class="far fa-edit"></i></button>
                                                <button type="button" class="btn btn-outline-danger"
                                                    title="Xóa camera sau"><i class="fas fa-trash"></i></button>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>2</td>
