                            ...
                            <div class="table-responsive">
                                <table id="zero_config" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>1</td>
                                            <td>Công nghệ màn hình 1</td>
                                            <td>Độ phân giải 1</td>
                                            <td>Màn hình rộng 1</td>
                                            <td>Độ sáng tối đa 1</td>
                                            <td>Mặt kính cảm ứng 1</td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>2</td>
                                            <td>Công nghệ màn hình 2</td>
                                            <td>Độ phân giải 2</td>
                                            <td>Màn hình rộng 2</td>
                                            <td>Độ sáng tối đa 2</td>
                                            <td>Mặt kính cảm ứng 2</td>
                                            <td>
                                                {{-- https://jsfiddle.net/prasun_sultania/KSk42/ hướng dẫn chỉnh lại title --}}
                                                <button type="button" class="btn btn-outline-secondary"
                                                    title="Chỉnh sửa thông tin màn hình"><i
