        ...
        <div class="page-breadcrumb">
            <div class="row">
                <div class="col-12 d-flex no-block align-items-center">
                    <h4 class="page-title">Cập nhật cửa hàng</h4>
                </div>
            </div>
        </div>
        <!-- ============================================================== -->
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <hr>
                            <form action="{{ route('cuaHang.update', ['cuaHang' => $cuaHang]) }}" method="post" accept-charset="utf-8">
                                @csrf
                                @method('PATCH')
                                <div class="row">
                                    <div class="col-sm-12">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <input class="form-control" name="tencuahang" type="text"
                                                            style="height: 40px;"
                                                            placeholder="Tên cửa hàng" value="{{ $cuaHang->ten_cua_hang }}" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <input class="form-control" name="diachi" type="text"
                                                            style="height: 40px;"
                                                            placeholder="Địa chỉ cửa hàng" value="{{ $cuaHang->dia_chi }}" required>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
