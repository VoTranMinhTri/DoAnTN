...
<html>
    <head>
        ...
        <script src="{{ asset('assets/js/jquery-1.4.4.min.js') }}" type="text/javascript"></script>
        <script src="{{ asset('assets/js/j360.js') }}" type="text/javascript"></script>
    ...
    <section class="clearfix footer__top">
        ...
        <div class="footer-col">
            <div class="f-certify">
                ...
                <a rel="nofollow" class="dmca-badge" href="https://www.dmca.com/Protection/Status.aspx?ID=5b62e759-2a0c-4d86-b972-af903bfbc89d&amp;refurl=https://www.thegioididong.com/dtdd/oppo-reno6-z-5g" target="_blank">
                ...
                <a class="_ncsc" rel="nofollow" href="https://tinnhiemmang.vn/danh-ba-tin-nhiem/thegioididongcom-1632835473" title="Chung nhan Tin Nhiem Mang" target="_blank">
                    <img class=" lazyloaded" width="150" alt="Chung nhan Tin Nhiem Mang" src="{{ asset('assets/images/handle_cert.png') }}">
                </a>
            </div>
        </div>
