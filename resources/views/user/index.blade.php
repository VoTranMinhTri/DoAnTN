            ...
            <div class="box-quicklink">
                <div class="lst-quickfilter wrap">
                    <a href="#" class="box-quicklink__item bd-radius quicklink-logo">
                        <img src="{{ asset('assets/user/images/logo-iphone.png') }}" class="no-text" width="30">
                    </a>
                    <a href="#" class="box-quicklink__item bd-radius quicklink-logo">
                        <img src="{{ asset('assets/user/images/logo-samsung.png') }}" class="no-text" width="30">
                    </a>
                    <a href="#" class="box-quicklink__item bd-radius quicklink-logo">
                        <img src="{{ asset('assets/user/images/logo-oppo.jpg') }}" class="no-text" width="30">
                    </a>
                    <a href="#" class="box-quicklink__item bd-radius quicklink-logo">
                        <img src="{{ asset('assets/user/images/logo-vivo.jpg') }}" class="no-text" width="30">
                    </a>
                    <a href="#" class="box-quicklink__item bd-radius quicklink-logo">
                        <img src="{{ asset('assets/user/images/logo-xiaomi.png') }}" class="no-text" width="30">
                    </a>
                    <a href="#" class="box-quicklink__item bd-radius quicklink-logo">
                        <img src="{{ asset('assets/user/images/logo-realme.png') }}" class="no-text" width="30">
                    </a>
                    <a href="#" class="box-quicklink__item bd-radius quicklink-logo">
                        <img src="{{ asset('assets/user/images/logo-nokia.jpg') }}" class="no-text" width="30">
                    </a>
                    <a href="#" class="box-quicklink__item bd-radius quicklink-logo">
                        <img src="{{ asset('assets/user/images/logo-mobell.jpg') }}" class="no-text" width="30">
                    </a>
                    <a href="#" class="box-quicklink__item bd-radius quicklink-logo">
                        <img src="{{ asset('assets/user/images/logo-itel.jpg') }}" class="no-text" width="30">
                    </a>
                    <a href="#" class="box-quicklink__item bd-radius quicklink-logo">
                        <img src="{{ asset('assets/user/images/logo-masstel.png') }}" class="no-text" width="30">
                    </a>
                    <a href="#" class="box-quicklink__item bd-radius quicklink-logo">
                        <img src="{{ asset('assets/user/images/logo-energizer.jpg') }}" class="no-text" width="30">
                    </a>
                </div>
            </div>
        </section>
