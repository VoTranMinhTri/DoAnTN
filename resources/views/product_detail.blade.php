...
@section('content')
    <section class='detail'>
        <ul class="breadcrumb">
            ...
            <li>
                <span>›</span>
                <a href="/dtdd-oppo">Điện thoại OPPO</a>
            ...
            <div class='box-main-left'>
                                    ...
                                    <div class='owl-stage'
                                        ...
                                        <div class='owl-item' style="width: 710px;">
                                            <a href="#" class="slider-item ">
                                                <img src="{{ asset('assets/images/oppo-reno6-z-5g-detail-1.jpg') }}"
                                        ...
                                        <div class="owl-item" style="width: 710px;"><a href="#" class="slider-item "
                                                ...
                                                <img class="owl-lazy" width="710" height="394" alt="OPPO Reno6 Z 5G"
                                                    style="opacity: 1;"
                                                    src="{{ asset('assets/images/oppo-reno6-z-5g-detail-2.jpg') }}">
                                            </a>
                                        </div>
                                        <div class="owl-item" style="width: 710px;"><a href="#" class="slider-item "
                                                data-gallery-id="featured-images-gallery">
                                                <img class="owl-lazy" width="710" height="394" alt="OPPO Reno6 Z 5G"
                                                    style="opacity: 1;"
                                                    src="{{ asset('assets/images/oppo-reno6-z-5g-detail-3.jpg') }}">
                                            </a>
                                        </div>
                                        <div class="owl-item" style="width: 710px;"><a href="#" class="slider-item "
                                                data-gallery-id="featured-images-gallery">
                                                <img class="owl-lazy" width="710" height="394" alt="OPPO Reno6 Z 5G"
                                                    style="opacity: 1;"
                                                    src="{{ asset('assets/images/oppo-reno6-z-5g-detail-4.jpg') }}">
                                            </a>
                                        </div>
                                        <div class="owl-item" style="width: 710px;"><a href="#" class="slider-item "
                                                data-gallery-id="featured-images-gallery">
                                                <img class="owl-lazy" width="710" height="394" alt="OPPO Reno6 Z 5G"
                                                    style="opacity: 1;"
                                                    src="{{ asset('assets/images/oppo-reno6-z-5g-detail-5.jpg') }}">
                                            </a>
                                        </div>
                                        <div class="owl-item" style="width: 710px;"><a href="#" class="slider-item "
                                                data-gallery-id="featured-images-gallery">
                                                <img class="owl-lazy" width="710" height="394" alt="OPPO Reno6 Z 5G"
                                                    style="opacity: 1;"
                                                    src="{{ asset('assets/images/oppo-reno6-z-5g-detail-6.jpg') }}">
                                            </a>
                                        </div>
                                        <div class="owl-item" style="width: 710px;"><a href="#" class="slider-item "
                                                data-gallery-id="featured-images-gallery">
                                                <img class="owl-lazy" width="710" height="394" alt="OPPO Reno6 Z 5G"
                                                    style="opacity: 1;"
                                                    src="{{ asset('assets/images/oppo-reno6-z-5g-detail-7.jpg') }}">
                                            </a>
                                        </div>
                                        <div class="owl-item" style="width: 710px;"><a href="#" class="slider-item "
                                                data-gallery-id="featured-images-gallery">
                                                <img class="owl-lazy" width="710" height="394" alt="OPPO Reno6 Z 5G"
                                                    style="opacity: 1;"
                                                    src="{{ asset('assets/images/oppo-reno6-z-5g-detail-8.jpg') }}">
                                            </a>
                                        </div>
                                        <div class="owl-item" style="width: 710px;"><a href="#" class="slider-item "
                                                data-gallery-id="featured-images-gallery">
                                                <img class="owl-lazy" width="710" height="394" alt="OPPO Reno6 Z 5G"
                                                    style="opacity: 1;"
                                                    src="{{ asset('assets/images/oppo-reno6-z-5g-detail-9.jpg') }}">
                                            </a>
                                        </div>
                                        <div class="owl-item" style="width: 710px;"><a href="#" class="slider-item "
                                                data-gallery-id="featured-images-gallery">
                                                <img class="owl-lazy" width="710" height="394" alt="OPPO Reno6 Z 5G"
                                                    style="opacity: 1;"
                                                    src="{{ asset('assets/images/oppo-reno6-z-5g-detail-10.jpg') }}">
                                            </a>
                                        </div>
                                        <div class="owl-item" style="width: 710px;"><a href="#" class="slider-item "
                                                data-gallery-id="featured-images-gallery">
                                                <img class="owl-lazy" width="710" height="394" alt="OPPO Reno6 Z 5G"
                                                    style="opacity: 1;"
                                                    src="{{ asset('assets/images/oppo-reno6-z-5g-detail-11.jpg') }}">
                                            </a>
                                        </div>
                                        <div class="owl-item" style="width: 710px;"><a href="#" class="slider-item "
                                                data-gallery-id="featured-images-gallery">
                                                <img class="owl-lazy" width="710" height="394" alt="OPPO Reno6 Z 5G"
                                                    style="opacity: 1;"
                                                    src="{{ asset('assets/images/oppo-reno6-z-5g-detail-12.jpg') }}">
                                            </a>
                                        </div>
                                        <div class="owl-item" style="width: 710px;"><a href="#" class="slider-item "
                                                data-gallery-id="featured-images-gallery">
                                                <img class="owl-lazy" width="710" height="394" alt="OPPO Reno6 Z 5G"
                                                    style="opacity: 1;"
                                                    src="{{ asset('assets/images/oppo-reno6-z-5g-detail-13.jpg') }}">
                                            </a>
                                        </div>
                                        <div class="owl-item" style="width: 710px;"><a href="#" class="slider-item "
                                                data-gallery-id="featured-images-gallery">
                                                <img class="owl-lazy" width="710" height="394" alt="OPPO Reno6 Z 5G"
                                                    style="opacity: 1;"
                                                    src="{{ asset('assets/images/oppo-reno6-z-5g-detail-14.jpg') }}">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class='detail-slider owl-carousel owl-loaded owl-drag'>
                                <div class='owl-stage-outer owl-height' style="height: 473.325px;">
                                    <div class='owl-stage'
                                        ...
                                        <div class='owl-item' style="width: 710px;">
                                            <a href="#" class="slider-item ">
                                                <img src="{{ asset('assets/images/oppo-reno6-z-5g-bac-1-org.jpg') }}"
                                        ...
                                        <div class="owl-item" style="width: 710px;"><a href="#" class="slider-item "
                                                ...
                                                <img class="owl-lazy" width="710" height="473.33px"
                                                    ...
                                                    style="opacity: 1;"
                                                    src="{{ asset('assets/images/oppo-reno6-z-5g-bac-2-org.jpg') }}">
                                            </a>
                                        </div>
                                        <div class="owl-item" style="width: 710px;"><a href="#" class="slider-item "
                                                data-gallery-id="featured-images-gallery">
                                                <img class="owl-lazy" width="710" height="473.33px"
                                                    alt="OPPO Reno6 Z 5G" class='owl-lazy' style='opacity: 1;'
                                                    style="opacity: 1;"
                                                    src="{{ asset('assets/images/oppo-reno6-z-5g-bac-3-org.jpg') }}">
                                            </a>
                                        </div>
                                        <div class="owl-item" style="width: 710px;"><a href="#" class="slider-item "
                                                data-gallery-id="featured-images-gallery">
                                                <img class="owl-lazy" width="710" height="473.33px"
                                                    alt="OPPO Reno6 Z 5G" class='owl-lazy' style='opacity: 1;'
                                                    style="opacity: 1;"
                                                    src="{{ asset('assets/images/oppo-reno6-z-5g-bac-4-org.jpg') }}">
                                            </a>
                                        </div>
                                        <div class="owl-item" style="width: 710px;"><a href="#" class="slider-item "
                                                data-gallery-id="featured-images-gallery">
                                                <img class="owl-lazy" width="710" height="473.33px"
                                                    alt="OPPO Reno6 Z 5G" class='owl-lazy' style='opacity: 1;'
                                                    style="opacity: 1;"
                                                    src="{{ asset('assets/images/oppo-reno6-z-5g-bac-5-org.jpg') }}">
                                            </a>
                                        </div>
                                        <div class="owl-item" style="width: 710px;"><a href="#" class="slider-item "
                                                data-gallery-id="featured-images-gallery">
                                                <img class="owl-lazy" width="710" height="473.33px"
                                                    alt="OPPO Reno6 Z 5G" class='owl-lazy' style='opacity: 1;'
                                                    style="opacity: 1;"
                                                    src="{{ asset('assets/images/oppo-reno6-z-5g-bac-6-org.jpg') }}">
                                            </a>
                                        </div>
                                        <div class="owl-item" style="width: 710px;"><a href="#" class="slider-item "
                                                data-gallery-id="featured-images-gallery">
                                                <img class="owl-lazy" width="710" height="473.33px"
                                                    alt="OPPO Reno6 Z 5G" class='owl-lazy' style='opacity: 1;'
                                                    style="opacity: 1;"
                                                    src="{{ asset('assets/images/oppo-reno6-z-5g-bac-7-org.jpg') }}">
                                            </a>
                                        </div>
                                        <div class="owl-item" style="width: 710px;"><a href="#" class="slider-item "
                                                data-gallery-id="featured-images-gallery">
                                                <img class="owl-lazy" width="710" height="473.33px"
                                                    alt="OPPO Reno6 Z 5G" class='owl-lazy' style='opacity: 1;'
                                                    style="opacity: 1;"
                                                    src="{{ asset('assets/images/oppo-reno6-z-5g-bac-8-org.jpg') }}">
                                            </a>
                                        </div>
                                        <div class="owl-item" style="width: 710px;"><a href="#" class="slider-item "
                                                data-gallery-id="featured-images-gallery">
                                                <img class="owl-lazy" width="710" height="473.33px"
                                                    alt="OPPO Reno6 Z 5G" class='owl-lazy' style='opacity: 1;'
                                                    style="opacity: 1;"
                                                    src="{{ asset('assets/images/oppo-reno6-z-5g-bac-9-org.jpg') }}">
                                            </a>
                                        </div>
                                        <div class="owl-item" style="width: 710px;"><a href="#" class="slider-item "
                                                data-gallery-id="featured-images-gallery">
                                                <img class="owl-lazy" width="710" height="473.33px"
                                                    alt="OPPO Reno6 Z 5G" class='owl-lazy' style='opacity: 1;'
                                                    style="opacity: 1;"
                                                    src="{{ asset('assets/images/oppo-reno6-z-5g-bac-10-org.jpg') }}">
                                            </a>
                                        </div>
                                        <div class="owl-item" style="width: 710px;"><a href="#" class="slider-item "
                                                data-gallery-id="featured-images-gallery">
                                                <img class="owl-lazy" width="710" height="473.33px"
                                                    alt="OPPO Reno6 Z 5G" class='owl-lazy' style='opacity: 1;'
                                                    style="opacity: 1;"
                                                    src="{{ asset('assets/images/oppo-reno6-z-5g-bac-11-org.jpg') }}">
                                            </a>
                                        </div>
                                        <div class="owl-item" style="width: 710px;"><a href="#" class="slider-item "
                                                data-gallery-id="featured-images-gallery">
                                                <img class="owl-lazy" width="710" height="473.33px"
                                                    alt="OPPO Reno6 Z 5G" class='owl-lazy' style='opacity: 1;'
                                                    style="opacity: 1;"
                                                    src="{{ asset('assets/images/oppo-reno6-z-5g-bac-12-org.jpg') }}">
                                            </a>
                                        </div>
                                        <div class="owl-item" style="width: 710px;"><a href="#" class="slider-item "
                                                data-gallery-id="featured-images-gallery">
                                                <img class="owl-lazy" width="710" height="473.33px"
                                                    alt="OPPO Reno6 Z 5G" class='owl-lazy' style='opacity: 1;'
                                                    style="opacity: 1;"
                                                    src="{{ asset('assets/images/oppo-reno6-z-5g-bac-13-org.jpg') }}">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class='detail-slider owl-carousel owl-loaded owl-drag'>
                                <div class='owl-stage-outer owl-height' style="height: 473.325px;">
                                    <div class='owl-stage'
                                        ...
                                        <div class='owl-item' style="width: 710px;">
                                            <a href="#" class="slider-item ">
                                                <img src="{{ asset('assets/images/oppo-reno6-z-5g-den-1-org.jpg') }}"
                                                    class='owl-lazy' style='opacity: 1;' alt="OPPO Reno6 Z 5G" width="710"
                                                    height="473.33px">
                                            </a>
                                        </div>
                                        <div class="owl-item" style="width: 710px;"><a href="#" class="slider-item "
                                                ...
                                                <img class="owl-lazy" width="710" height="473.33px"
                                                    alt="OPPO Reno6 Z 5G" class='owl-lazy' style='opacity: 1;'
                                                    style="opacity: 1;"
                                                    src="{{ asset('assets/images/oppo-reno6-z-5g-den-2-org.jpg') }}">
                                            </a>
                                        </div>
                                        <div class="owl-item" style="width: 710px;"><a href="#"
                                                ...
                                                <img class="owl-lazy" width="710" height="473.33px"
                                                    alt="OPPO Reno6 Z 5G" class='owl-lazy' style='opacity: 1;'
                                                    style="opacity: 1;"
                                                    src="{{ asset('assets/images/oppo-reno6-z-5g-den-3-org.jpg') }}">
                                            </a>
                                        </div>
                                        <div class="owl-item" style="width: 710px;"><a href="#"
                                                class="slider-item " data-gallery-id="featured-images-gallery">
                                                <img class="owl-lazy" width="710" height="473.33px"
                                                    alt="OPPO Reno6 Z 5G" class='owl-lazy' style='opacity: 1;'
                                                    style="opacity: 1;"
                                                    src="{{ asset('assets/images/oppo-reno6-z-5g-den-4-org.jpg') }}">
                                            </a>
                                        </div>
                                        <div class="owl-item" style="width: 710px;"><a href="#"
                                                class="slider-item " data-gallery-id="featured-images-gallery">
                                                <img class="owl-lazy" width="710" height="473.33px"
                                                    alt="OPPO Reno6 Z 5G" class='owl-lazy' style='opacity: 1;'
                                                    style="opacity: 1;"
                                                    src="{{ asset('assets/images/oppo-reno6-z-5g-den-5-org.jpg') }}">
                                            </a>
                                        </div>
                                        <div class="owl-item" style="width: 710px;"><a href="#"
                                                class="slider-item " data-gallery-id="featured-images-gallery">
                                                <img class="owl-lazy" width="710" height="473.33px"
                                                    alt="OPPO Reno6 Z 5G" class='owl-lazy' style='opacity: 1;'
                                                    style="opacity: 1;"
                                                    src="{{ asset('assets/images/oppo-reno6-z-5g-den-6-org.jpg') }}">
                                            </a>
                                        </div>
                                        <div class="owl-item" style="width: 710px;"><a href="#"
                                                class="slider-item " data-gallery-id="featured-images-gallery">
                                                <img class="owl-lazy" width="710" height="473.33px"
                                                    alt="OPPO Reno6 Z 5G" class='owl-lazy' style='opacity: 1;'
                                                    style="opacity: 1;"
                                                    src="{{ asset('assets/images/oppo-reno6-z-5g-den-7-org.jpg') }}">
                                            </a>
                                        </div>
                                        <div class="owl-item" style="width: 710px;"><a href="#"
                                                class="slider-item " data-gallery-id="featured-images-gallery">
                                                <img class="owl-lazy" width="710" height="473.33px"
                                                    alt="OPPO Reno6 Z 5G" class='owl-lazy' style='opacity: 1;'
                                                    style="opacity: 1;"
                                                    src="{{ asset('assets/images/oppo-reno6-z-5g-den-8-org.jpg') }}">
                                            </a>
                                        </div>
                                        <div class="owl-item" style="width: 710px;"><a href="#"
                                                class="slider-item " data-gallery-id="featured-images-gallery">
                                                <img class="owl-lazy" width="710" height="473.33px"
                                                    alt="OPPO Reno6 Z 5G" class='owl-lazy' style='opacity: 1;'
                                                    style="opacity: 1;"
                                                    src="{{ asset('assets/images/oppo-reno6-z-5g-den-9-org.jpg') }}">
                                            </a>
                                        </div>
                                        <div class="owl-item" style="width: 710px;"><a href="#"
                                                class="slider-item " data-gallery-id="featured-images-gallery">
                                                <img class="owl-lazy" width="710" height="473.33px"
                                                    alt="OPPO Reno6 Z 5G" class='owl-lazy' style='opacity: 1;'
                                                    style="opacity: 1;"
                                                    src="{{ asset('assets/images/oppo-reno6-z-5g-den-10-org.jpg') }}">
                                            </a>
                                        </div>
                                        <div class="owl-item" style="width: 710px;"><a href="#"
                                                class="slider-item " data-gallery-id="featured-images-gallery">
                                                <img class="owl-lazy" width="710" height="473.33px"
                                                    alt="OPPO Reno6 Z 5G" class='owl-lazy' style='opacity: 1;'
                                                    style="opacity: 1;"
                                                    src="{{ asset('assets/images/oppo-reno6-z-5g-den-11-org.jpg') }}">
                                            </a>
                                        </div>
                                        <div class="owl-item" style="width: 710px;"><a href="#"
                                                class="slider-item " data-gallery-id="featured-images-gallery">
                                                <img class="owl-lazy" width="710" height="473.33px"
                                                    alt="OPPO Reno6 Z 5G" class='owl-lazy' style='opacity: 1;'
                                                    style="opacity: 1;"
                                                    src="{{ asset('assets/images/oppo-reno6-z-5g-den-12-org.jpg') }}">
                                            </a>
                                        </div>
                                        <div class="owl-item" style="width: 710px;"><a href="#"
                                                class="slider-item " data-gallery-id="featured-images-gallery">
                                                <img class="owl-lazy" width="710" height="473.33px"
                                                    alt="OPPO Reno6 Z 5G" class='owl-lazy' style='opacity: 1;'
                                                    style="opacity: 1;"
                                                    src="{{ asset('assets/images/oppo-reno6-z-5g-den-13-org.jpg') }}">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div id="thumb-color-images-gallery-5" class="item itemTab"
                                ...
                                <div class="item-border">
                                    <img alt="Bạc" width="41" height="41" loading="lazy" class=" lazyloaded"
                                        src="{{ asset('assets/images/oppo-reno6-z-5g-aurora-1-200x200.jpg') }}">
                                </div>
                                <p>Bạc</p>
                            </div>
                            <div id="thumb-color-images-gallery-11" class="item itemTab"
                                ...
                                <div class="item-border">
                                    <img alt="Đen" width="41" height="41" loading="lazy" class=" lazyloaded"
                                        src="{{ asset('assets/images/oppo-reno6-z-5g-black-1-200x200.jpg') }}">
                                </div>
                                <p>Đen</p>
                            </div>
                ...
                <div class="block-tab">
                    ...
                    <div class="block-tab-content">
                        ...
                        <div class="content-t" data-tab-id="tab-specification-gallery-0"
                            ...
                            <div class="img">
                                <img src="{{ asset('assets/images/oppo-reno6-z-5g-note-2.jpg') }}" alt="OPPO Reno6 Z 5G">
                            </div>
                                ...
                                <div class="article-content showall review-post">
                                    ...
                                    <p><a class="preventdefault"
                                            ...
                                            onclick="return false;"><img alt="OPPO Reno6 Z 5G - Cụm camera sau"
                                                ...
                                                src="{{ asset('assets/images/oppo-reno6-z-5g-01.jpg') }}"></a>
                                    </p>
                                    ...
                                    <p><a class="preventdefault"
                                            ...
                                            onclick="return false;"><img alt="OPPO Reno6 Z 5G - Ảnh chụp trên camera"
                                                ...
                                                src="{{ asset('assets/images/oppo-reno6-z-5g-02.jpg') }}"></a>
                                    </p>
                                    ...
                                    <p><a class="preventdefault"
                                            ...
                                            onclick="return false;"><img alt="OPPO Reno6 Z 5G - Ảnh chụp trên camera"
                                                ...
                                                src="{{ asset('assets/images/reno6-z-5g-34.jpg') }}"></a>
                                    </p>
                                    ...
                                    <p><a class="preventdefault"
                                            ...
                                            onclick="return false;"><img alt="OPPO Reno6 Z 5G - Ảnh chụp trên camera"
                                                ...
                                                class=" ls-is-cached lazyloaded"
                                                title="OPPO Reno6 Z 5G - Ảnh chụp trên camera"
                                                src="{{ asset('assets/images/reno6-z-5g-23.jpg') }}"></a>
                                    </p>
                                    ...
                                    <p><a class="preventdefault"
                                            ...
                                            onclick="return false;"><img alt="OPPO Reno6 Z 5G - Live HDR"
                                                ...
                                                src="{{ asset('assets/images/oppo-reno6-z-5g-42.jpg') }}"></a>
                                    </p>
                                    ...
                                    <p><a class="preventdefault"
                                            ...
                                            onclick="return false;"><img alt="OPPO Reno6Z 5G - Camera"
                                                ...
                                                src="{{ asset('assets/images/oppo-reno6-z-5g-41.jpg') }}"></a>
                                    </p>
                                    ...
                                    <p><a class="preventdefault"
                                            ...
                                            onclick="return false;"><img alt="OPPO Reno6 Z 5G - Thiết kế mỏng nhẹ 173 g"
                                                ...
                                                src="{{ asset('assets/images/oppo-reno6-z-5g-04.jpg') }}"></a>
                                    </p>
                                    ...
                                    <p><a class="preventdefault"
                                            ...
                                            onclick="return false;"><img
                                                ...
                                                src="{{ asset('assets/images/oppo-reno6-z-5g-03.jpg') }}"></a>
                                    </p>
                                    ...
                                    <p><a class="preventdefault"
                                            ...
                                            onclick="return false;"><img
                                                ...
                                                src="{{ asset('assets/images/reno6-z-5g-29.jpg') }}"></a>
                                    </p>
                                    ...
                                    <p><a class="preventdefault"
                                            ...
                                            onclick="return false;"><img alt="OPPO Reno6 Z 5G - Trang bị màn hình AMOLED"
                                                ...
                                                src="{{ asset('assets/images/reno6-z-5g-24.jpg') }}"></a>
                                    </p>
                                    ...
                                    <p><a class="preventdefault"
                                            ...
                                            onclick="return false;"><img alt="OPPO Reno6 Z 5G - Thiết kế"
                                                ...
                                                src="{{ asset('assets/images/reno6-z-5g-20.jpg') }}"></a>
                                    </p>
                                    ...
                                    <p><a class="preventdefault"
                                            ...
                                            onclick="return false;"><img
                                                ...
                                                src="{{ asset('assets/images/reno6-z-5g-25.jpg') }}"></a>
                                    </p>
                                    ...
                                    <p><a class="preventdefault"
                                            ...
                                            onclick="return false;"><img
                                                ...
                                                src="{{ asset('assets/images/reno6-z-5g-26.jpg') }}"></a>
                                    </p>
                                    ...
                                    <p><a class="preventdefault"
                                            ...
                                            onclick="return false;"><img
                                                ...
                                                src="{{ asset('assets/images/oppo-reno6-z-5g-2.jpg') }}"></a>
                                    </p>
                                    ...
                                    <p><a class="preventdefault"
                                            ...
                                            onclick="return false;"><img alt="OPPO Reno6Z 5G - RAM"
                                                ...
                                                src="{{ asset('assets/images/reno6-z-5g-30.jpg') }}"></a>
                                    </p>
                                    ...
                                    <p><a class="preventdefault"
                                            ...
                                            onclick="return false;"><img
                                                ...
                                                src="{{ asset('assets/images/reno6-z-5g-14.jpg') }}"></a>
                                    </p>
                                    ...
                                    <p><a class="preventdefault"
                                            ...
                                            onclick="return false;"><img alt="OPPO Reno6 Z 5G - Dung lượng pin lớn 4310 mAh"
                                                ...
                                                src="{{ asset('assets/images/reno6-z-5g-12.jpg') }}"></a>
                                    </p>
                                    ...
                                    <p><a class="preventdefault"
                                            ...
                                            onclick="return false;"><img alt="OPPO Reno6 Z 5G - Hỗ trợ sạc nhanh 30 W"
                                                ...
                                                src="{{ asset('assets/images/reno6-z-5g-31.jpg') }}"></a>
                                    </p>
                ...
                <div class="img-main">
                    <img class=" lazyloaded" alt="Điện thoại OPPO Reno6 Z 5G"
                        src="{{ asset('assets/images/oppo-reno6-z-5g-note-2.jpg') }}">
                </div>
                <div class="article content-t-wrap">
    ...
    <script src="{{ asset('assets/js/banner-tab-product-detail.js') }}"></script>
    <script src="{{ asset('assets/js/block-tab-detail.js') }}"></script>
    <script src="{{ asset('assets/js/box-scroll.js') }}"></script>
@endsection
